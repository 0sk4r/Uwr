...
plot "figure.dat" using 1:2 with lines title "v0" linestyle 1 , \
    "figure.dat" using 1:3 with lines title "v1" linestyle 2 , \
    "figure.dat" using 1:4 with lines title "v2" linestyle 3 , \
    "figure.dat" using 1:5 with lines title "v3(8)" linestyle 4, \
    "figure.dat" using 1:6 with lines title "v3(16)" linestyle 5, \
    "figure.dat" using 1:7 with lines title "v3(32)" linestyle 6, \
    "figure.dat" using 1:8 with lines title "v3(64)" linestyle 7
