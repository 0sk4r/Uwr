...
plot "zad3int.dat" using 1:2 with lines title "v0" linestyle 1 , \
    "zad3int.dat" using 1:3 with lines title "v1(8)" linestyle 2 , \
    "zad3int.dat" using 1:4 with lines title "v1(16)" linestyle 3 , \
    "zad3int.dat" using 1:5 with lines title "v1(32)" linestyle 4
