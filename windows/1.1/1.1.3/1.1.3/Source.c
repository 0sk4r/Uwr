...
#define ID_ACCEPT 101
#define ID_CANCEL 102
#define ID_DZIENNE 103
#define ID_UZUPELNIAJACE 104
#define ID_CYKL 105
  ...
  WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_CREATE:
    ...
    chkDzienne = CreateWindowEx(0, WC_BUTTON, TEXT("dzienne"), WS_CHILD | WS_VISIBLE | BS_CHECKBOX, 100, 160, 80, 20, hwnd, ID_DZIENNE, *hMainInstance, 0);
    chkUzupelniajace = CreateWindowEx(0, WC_BUTTON, TEXT("uzupełniające"), WS_CHILD | WS_VISIBLE | BS_CHECKBOX, 230, 160, 140, 20, hwnd, ID_UZUPELNIAJACE, *hMainInstance, 0);
    btnAkceptuj = CreateWindowEx(0, WC_BUTTON, TEXT("Akceptuj"), WS_CHILD | WS_VISIBLE, 5, 220, 150, 30, hwnd, ID_ACCEPT, *hMainInstance, 0);
    btnAnuluj = CreateWindowEx(0, WC_BUTTON, TEXT("Anuluj"), WS_CHILD | WS_VISIBLE, 330, 220, 150, 30, hwnd, ID_CANCEL, *hMainInstance, 0);
    break;
  case WM_PAINT:
  ...
  case WM_COMMAND:
    ...
    case ID_ACCEPT:
      ...
      if (IsDlgButtonChecked(hwnd, ID_DZIENNE) == BST_CHECKED)
        StringCchCat(buf, 200, TEXT("\ndzienne"));

      if (IsDlgButtonChecked(hwnd, ID_UZUPELNIAJACE) == BST_CHECKED)
      ...
      break;
    case ID_DZIENNE:
      CheckDlgButton(hwnd, ID_DZIENNE, !IsDlgButtonChecked(hwnd, ID_DZIENNE));
      break;
    case ID_UZUPELNIAJACE:
      CheckDlgButton(hwnd, ID_UZUPELNIAJACE, !IsDlgButtonChecked(hwnd, ID_UZUPELNIAJACE));
      break;
    }
    break;
  default:
