...
class Tests(unittest.TestCase):
    ...
    def test_korekta(self):
        self.assertEqual(L4Z3.korekta("to jest testowy string"),
                         "To jest testowy string. ")
        self.assertEqual(L4Z3.korekta("to jest testowy string."),
                         "To jest testowy string. ")
        self.assertEqual(L4Z3.korekta(
            "to jest testowy string. "), "To jest testowy string. ")
        self.assertEqual(L4Z3.korekta("To jest testowy string."),
                         "To jest testowy string. ")
        self.assertEqual(L4Z3.korekta(
            "To jest testowy string. "), "To jest testowy string. ")
    ...
    def test_zdania(self):
        str = StringIO(
            "to jest testowy string. Iterator powinien zwr.acac z niego pojedyncze zdania.\ncokolwiek to znaczy.")
        it = L4Z3.zdania(StringIO(
            "to jest testowy string. Iterator powinien zwr.acac z niego pojedyncze zdania.\ncokolwiek to znaczy."))

        self.assertEqual(list(L4Z3.zdania(str)), ['to jest testowy string.', 'Iterator powinien zwr.', 'acac z niego pojedyncze zdania.',
                                                  'cokolwiek to znaczy.'])
